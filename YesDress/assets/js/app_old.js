...
// drop-list filter
$('.catalog__filter_item__drop-button').click(function(){
	if ($(this).hasClass('vision-attr')){
		$(this).removeClass('vision-attr')
		$(this).siblings('.catalog__filter_item__drop-list').slideToggle(300, 'linear').css({'display': 'flex'});
	} else {
		$(this).addClass('vision-attr')
		$(this).siblings('.catalog__filter_item__drop-list').slideToggle(300, 'linear');
	}
})
