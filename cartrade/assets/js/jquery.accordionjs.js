  ...
  $.fn.accordionjs = function(options) {
    ...
    */
    ...
    function setSizes(){
      ...
      var titleHeight = $('.accordionjs-title').outerHeight();
      if ($(window).innerWidth() > 1300) {
        $(".accordionjs > li").css("margin-right", "-"+sliderWidth+"px");      
        $(".accordionjs-content").css("width", contentWidth-1+"px");
        ...
        $(".accordionjs-select").css("height", titleHeight+'px');
      }
    }
    ...
    function _createHTMLForStep(node, step){
      ...
      $(node).append('<div class="accordionjs-title">' +
                    ...
                    '<p class="jobStep fa fa-rotate-90 ">'+(step.number+1)+'</p>' +
                    '</div>');
